package io.crcell.simply.utils;
...
import static io.crcell.simply.utils.GsonTools.ArrayStrategy.REPLACE;
import static io.crcell.simply.utils.GsonTools.ConflictStrategy.PREFER_SECOND_OBJ;
        ...
        for (Map.Entry<String, JsonElement> rightEntry : rightObj.entrySet()) {
            ...
            if (leftObj.has(rightKey)) {
                ...
                if (leftVal.isJsonArray() && rightVal.isJsonArray()) {
                    ...
                    //recursive merging
                    extendJsonObject(leftVal.getAsJsonObject(), rightVal.getAsJsonObject(), conflictStrategy, arrayStrategy);
