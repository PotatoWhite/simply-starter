...
public class EventableAspect {
  ...
  @After(value = "execution(* io.crcell.pramework.eventable.repository.EventableRepository.save(..))")
  ...
  @After(value = "execution(* io.crcell.pramework.eventable.repository.EventableRepository.deleteById(..))")
  ...
  @After(value = "execution(* io.crcell.pramework.eventable.repository.EventableRepository.delete(..))")
